...
python main.py --U_method continuous_update_finetune2 --dataset_name sst5 --net_name pythia70m --batch_size 32 --lr 0.00001  --trials 3 --proportion_of_group_unlearn 0.01 --num_epochs 10  --device cuda:0
