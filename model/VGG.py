...
def make_layers(cfg, batch_norm=True, input_channel=3):
    layers = []
...
def vgg11_bn(input_channel=3, num_classes=100):
...
def vgg19_bn(input_channel=3, num_classes=100):
...
def get_utkface():
   ...
   # dataset = UTKFaceDataset(root="../data", attr="race", transform=transform)
    input_channel = 3
    num_classes = 4
    return num_classes,  input_channel
