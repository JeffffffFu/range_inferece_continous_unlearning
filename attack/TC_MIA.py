...
def TC_MIA(args):
    ...
    #(2:1:2),(2:1:4),(4:1:2)
  #  mem_train,Pin,Pout,train_sample_label=adjust_ratio_samples(mem_train,Pin,Pout,train_sample_label,target_ratio=(4, 1, 2))
   ...
   # for method in ["LO"]:
      ...
      #  print(method,Micro_F1,F1_list)

      #  print(f"Dataset:{args['dataset_name']}|Flag:{args['flag']}|method:{method}|Micro_F1:{Micro_F1}|F1_list:{F1_list}")
